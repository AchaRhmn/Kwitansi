            ...
            <tr>
                <td colspan="2">
                    ...
                    <table class="tabel1">
                        ...
                        <tr>
                            <td rowspan="2"><h2 id="h22">
                                Receipt</h2>
                            </td>
                            
                            <td class="nom">Tgl</td></div>
                    ...
                    <table class="tabel4">
                        ...
                        <tr>
                            ...
                            <td class="check">
                                ...
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <input type="radio" name="metode" value="cheque"> Cheque </td>
                            <td class="check">
                        ...
                        <tr>
                            <td class="nom2">Date</td>
                            <td colspan="2"></td>
                            <td><center><input class="ttdf" type="text" name="ttd"
                            placeholder="(.......................................)"></center></td>
                        </tr>
